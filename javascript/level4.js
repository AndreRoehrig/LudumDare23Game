(function() {
  ...
  level4draw = function() {
    ...
    if (smileydead === 0) {
      ...
      if (wallfullMaskOverlap) console.log("kollision");
    }
    if (smileydead === 1) {
    ...
    if (smileyMaskOverlap && charsize <= 200) console.log("die");
