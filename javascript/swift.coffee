...
director = ->
    if level == 0 and levelchecker != 0
        gamejs.time.fpsCallback(startscreen, this, 30)
        levelchecker = 0
    
    if level != 0 then gamejs.time.deleteCallback(startscreen,30)

    if level == 1 and levelchecker != 1
        level1()
        levelchecker = 1
